...
class MappingPlugin(idaapi.plugin_t):
    flags = idaapi.PLUGIN_KEEP
    comment = "Mapping Table Extractor - Char Arm 2"
    help = "Scan and extract special char table"
    wanted_name = "Char Mapping Viewer - Char Arm 2"
    ...
    def run(self, arg):
        ...
        self.form.Show("Char Arm 2 Mapping Analysis")
